...
_______,S(KC_INT1),S(KC_INT3),MO(_MEDIA),S(KC_HOME),S(KC_END), _______, _______, _______, _______, KC_CAPS, _______
    ...
    [_FUNC] = LAYOUT(
      TG(_FUNC),   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,
         MS_ACL1, _______, _______, _______, _______, MS_WHLL, MS_LEFT, MS_DOWN,   MS_UP, MS_RGHT, MS_WHLR,  MS_RST,
    MS_ACL2, _______, _______, MO(_CONFIG), _______, _______, MS_WHLD, MS_BTN1, _______, MS_BTN2, MS_WHLU, _______
    ),
    [_MEDIA] = LAYOUT(
