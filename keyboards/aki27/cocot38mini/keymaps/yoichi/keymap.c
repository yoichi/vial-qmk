...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_LALT, RCTL_T(KC_DEL), LT(_NUMBER,KC_SPC), KC_LGUI, MS_BTN1, LT(_SYMBOL,KC_ENT), KC_BSPC
    ),
    [_NUMBER] = LAYOUT(
        ...
        KC_RSFT, XXXXXXX, KC_INS,  KC_HOME, KC_BSLS,          KC_QUOT, KC_END,  KC_COMM, KC_DOT,  RSFT_T(KC_SLSH),
                          _______, _______, _______, IME_TGL, MS_BTN2, TT(_FUNC), _______
    ),
    [_SYMBOL] = LAYOUT(
        S(KC_1), S(KC_2), S(KC_3), S(KC_4), S(KC_5),          S(KC_6), S(KC_7), S(KC_8), S(KC_9), S(KC_0),
S(KC_MINS),S(KC_EQL),S(KC_GRV),S(KC_LBRC),S(KC_RBRC),S(KC_TAB),S(KC_LEFT),S(KC_DOWN),S(KC_UP),S(KC_RGHT),S(KC_SCLN),
        XXXXXXX, XXXXXXX,S(KC_INS),S(KC_HOME),S(KC_BSLS),     S(KC_QUOT),S(KC_END),S(KC_COMM),S(KC_DOT),S(KC_SLSH),
                       _______, _______, TT(_MEDIA), _______, MS_BTN2, XXXXXXX, XXXXXXX
    ),
    [_FUNC] = LAYOUT(
        ...
        KC_LSFT,C(KC_LEFT),C(KC_DOWN),C(KC_UP),C(KC_RGHT),    LCA(KC_LEFT),LCA(KC_DOWN),LCA(KC_UP),LCA(KC_RGHT),KC_F11,
                          XXXXXXX, KC_RALT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    [_MEDIA] = LAYOUT(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, KC_BRIU, KC_VOLU,
        QK_RBT,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_INT1, KC_INT3, XXXXXXX, KC_BRID, KC_VOLD,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     S(KC_INT1),S(KC_INT3), XXXXXXX, XXXXXXX, KC_MUTE,
