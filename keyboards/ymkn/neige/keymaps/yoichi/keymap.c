...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
  LT(_SYMBOL,KC_TAB), ALT_T(KC_Q), KC_W,  KC_E,  KC_R,  KC_T,  KC_Y,  KC_U,  KC_I,  KC_O,  KC_P, LT(_NUMBER,KC_BSPC),
...
_______,S(KC_INT1),S(KC_INT3),MO(_MEDIA),S(KC_HOME),S(KC_END), _______, _______, _______, _______, _______, _______
    ...
    MO(_CONFIG),   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,
      ...
      TG(_FUNC), _______, _______, _______, _______, _______, MS_BTN1, _______, MS_BTN2, MS_WHLD, MS_WHLU, TG(_FUNC)
    ),
    [_MEDIA] = LAYOUT(
