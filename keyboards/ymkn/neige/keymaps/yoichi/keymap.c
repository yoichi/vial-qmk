...
KC_LSFT, LALT_T(KC_Z), LGUI_T(KC_X), LT(_NUMBER, KC_C), KC_V, KC_B, KC_N, LT(_SYMBOL, KC_M), KC_COMM, KC_DOT, KC_SLSH, KC_RSFT
	),
	[_NUMBER] = LAYOUT(
		KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_DEL,
		KC_QUOT, KC_MINS, KC_EQL, KC_GRV, KC_LBRC, KC_RBRC, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_SCLN, KC_BSLS,
		_______, KC_INT1, KC_INT3, _______, KC_HOME, KC_END, _______, TG(_FUNC), KC_COMM, KC_DOT, KC_SLSH, _______
	),
	[_SYMBOL] = LAYOUT(
...
S(KC_QUOT), S(KC_MINS), S(KC_EQL), S(KC_GRV), S(KC_LBRC), S(KC_RBRC), S(KC_LEFT), S(KC_DOWN), S(KC_UP), S(KC_RGHT), S(KC_SCLN), S(KC_BSLS),
	...
	[_FUNC] = LAYOUT(
		MO(_CONFIG), KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,
		_______, _______, _______, _______, _______, _______, MS_LEFT, MS_DOWN, MS_UP, MS_RGHT, _______, _______,
		TG(_FUNC), _______, _______, _______, _______, _______, MS_BTN1, _______, MS_BTN2, _______, _______, TG(_FUNC)
	),
	[_MEDIA] = LAYOUT(
